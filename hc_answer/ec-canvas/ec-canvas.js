    ...
    methods: {
        init: function(a) {
            ...
            if (1 < t[0] || 1 === t[0] && 9 < t[1] || 1 === t[0] && 9 === t[1] && 91 <= t[2]) {
                ...
                var c = new _wxCanvas2.default(ctx, this.data.canvasId);
                echarts.setCanvasCreator(function() {
                    return c;
                }), wx.createSelectorQuery().in(this).select(".ec-canvas").boundingClientRect(function(t) {
                    "function" == typeof a ? e.chart = a(c, t.width, t.height) : e.data.ec && e.data.ec.onInit && (e.chart = e.data.ec.onInit(c, t.width, t.height));
                }).exec();
        ...
        touchStart: function(t) {
            if (!this.data.ec.disableTouch && this.chart && 0 < t.touches.length) {
                var a = t.touches[0];
