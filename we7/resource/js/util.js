...
util.base64_encode = function(e) {
    ...
    var n = wx.getStorageSync("userInfo").sessionid, s = r.url;
    ...
    var o = getSign(s, r.data);
    if (o && (s = s + "&sign=" + o), !s) return !1;
    if (r.cachetime) {
        var u = t(s), c = wx.getStorageSync(u), f = Date.parse(new Date());
        if (c && c.data) {
            if (c.expire > f) return r.complete && "function" == typeof r.complete && r.complete(c), 
            r.success && "function" == typeof r.success && r.success(c), console.log("cache:" + s), 
            !0;
    ...
    wx.request((_defineProperty(e = {
        ...
        var t = require("md5.js")(s), n = wx.getStorageSync(t);
    ...
    this.isLeapYear = function(e) {
        ...
        var s = 0;
        -1 < (r = e.indexOf("MM")) && r < a && (s = parseInt(t.substr(r, 2)) - 1);
        var i = 0;
        -1 < (r = e.indexOf("dd")) && r < a && (i = parseInt(t.substr(r, 2)));
        var o = 0;
        (-1 < (r = e.indexOf("HH")) || 1 < (r = e.indexOf("hh"))) && r < a && (o = parseInt(t.substr(r, 2)));
        var u = 0;
        -1 < (r = e.indexOf("mm")) && r < a && (u = t.substr(r, 2));
        var c = 0;
        return -1 < (r = e.indexOf("ss")) && r < a && (c = t.substr(r, 2)), new Date(n, s, i, o, u, c);
        ...
        return !(!isNumber(r) || "2100" < r || r < "1900") && (!(!isNumber(s) || "12" < s || s < "01") && !(o > getMaxDay(r, s) || o < "01"));
